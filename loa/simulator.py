...
class Simulator:    
    ...
    def play(self, team1: Team, team2: Team, num_repeats=1):     
        ...
        for i in range(num_repeats):            
            ...
            for t in range(self.num_turns):
                ...
                self._check_consistency(offense, offense_cpy, "arragement")
                
                # Attack
                self._apply_attack(offense, defense)
                #self.check_consistency(offense, offense_cpy, "attack")
                
                self._clear_dead(offense)
                self._clear_dead(defense)
    ...
    def _clear_dead(self, team: Team):
    ...
    def _check_consistency(self, obj1, obj2, situation):
